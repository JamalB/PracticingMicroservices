I have just attended this Course. and I found it really Good.
this is the link of this Couse
...
## In This Repository
implemented below **features over the run-aspnetcore-microservices repository**.
...
5. Launch http://host.docker.internal:8006 in your browser to view the Web UI. You can use Web project in order to **call microservices over API Gateway**. When you **checkout the basket** you can follow **queue record on RabbitMQ dashboard**.
